...
outputdir = ['/mindhive/evlab/u/mekline/Documents/Projects/AgentPatient_Pilot2/' ...
    'AgentPatient_Pilot/Analysis_pilot2/loc_langloc_crit_langloc_20171230_no_430/'];
...
experiments(2)= struct(...
    ...
    'pwd2','firstlevel_langlocSN',...
    'data',{{ ...
        '632_FED_20170825a_3T2_PL2017',...
        '641_FED_20170824a_3T2_PL2017'
        }});% important that this is the same order as above
%% DO NOT FORGET TO CHANGE OUTPUT DIRECTORY, OR DO THE STRUCT BELOW
...
ss=struct(...
    ...
    'EffectOfInterest_contrasts',{{'S','N','S-N'}},... % contrasts of interest; here you just indicate the names of the four conditions
