...
experiments(1)=struct(...
    ...
    'data',{{
        ...
        '215_FED_20150615d_3T2', ...
        '296_FED_20150625b_3T2', ...
        '298_FED_20150625d_3T2', ...
        '280_FED_20150811c_3T1', ...
        '018_FED_20150817a_3T1'
        }}); % subject IDs
experiments(2)=struct(...
    'name','expt2',...% non-lang expt
    'pwd1','/mindhive/evlab/u/Shared/SUBJECTS',...
    'pwd2','firstlevel_IARPAlex_sentences_syntcat',...  % path to the first-level analysis directory for the critical task
    'data',{{
        '288_FED_20150613a_3T1', ...
        '289_FED_20150619a_3T1', ...
        '215_FED_20150729a_3T1', ...
        '296_FED_20150810a_3T1', ...
        '298_FED_20150811b_3T1', ...
        '280_FED_20150813a_3T1', ...
        '018_FED_20150818a_3T1'
        }});
